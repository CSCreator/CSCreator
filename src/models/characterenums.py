...
ch_property_type = {
    ...
    CHProperty.WIS: str,
    CHProperty.CHA: str,
    CHProperty.STR_MOD: str,
    CHProperty.DEX_MOD: str,
    CHProperty.CON_MOD: str,
    CHProperty.INT_MOD: str,
    CHProperty.WIS_MOD: str,
    CHProperty.CHA_MOD: str,
    ...
    CHProperty.STR_ST_MOD: str,
    CHProperty.DEX_ST_MOD: str,
    CHProperty.CON_ST_MOD: str,
    CHProperty.INT_ST_MOD: str,
    CHProperty.WIS_ST_MOD: str,
    CHProperty.CHA_ST_MOD: str,
    CHProperty.DEFENSES: str,
    CHProperty.SAVE_MODIFIERS: str,
    CHProperty.PASSIVE_PERCEPTION: str,
    CHProperty.PASSIVE_WISDOM: str,
    CHProperty.PASSIVE_INVESTIGATION: str,
    CHProperty.SENSES: str,
    CHProperty.INITIATIVE: str,
    CHProperty.AC: str,
    CHProperty.PROF_BONUS: str,
    CHProperty.ABILITYSAVEDC1: str,
    CHProperty.ABILITYSAVESCORE1: str,
    CHProperty.ABILITYSAVESCORE2: str,
    CHProperty.ABILITYSAVEDC2: str,
    CHProperty.SPEED: str,
    CHProperty.MAX_HP: str,
    CHProperty.CURRENT_HP: str,
    CHProperty.TEMP_HP: str,
    CHProperty.TOTAL_HIT_DICE: str,
    CHProperty.HIT_DICE: str,
    CHProperty.SUCCESSFUL_SAVE_1: str,
    CHProperty.SUCCESSFUL_SAVE_2: str,
    CHProperty.SUCCESSFUL_SAVE_3: str,
    CHProperty.FAILED_SAVE_1: str,
    CHProperty.FAILED_SAVE_2: str,
    CHProperty.FAILED_SAVE_3: str,
    CHProperty.PROFICIENCIES_LANGUAGES: str,
    CHProperty.ACTIONS: str,
    CHProperty.ATTACKS: str,
