...
from src.models.charactersubmodel import CustomTableModel, CustomTableItemType, Equipment, Spell, SpellSlot, Skill, \
    Attack, WeaponProf, ArmorProf, LanguageProf, ToolProf
...
class CharacterController:
    def __init__(self) -> None:
        ...
        layout_per_submodel = {
            self.character_view.char_layout.EQUIPMENT_LAYOUT: self.player_model.conversion[Equipment],
            self.character_view.char_layout.SPELL_LAYOUT: self.player_model.conversion[Spell],
            self.character_view.char_layout.SPELLSLOT_LAYOUT: self.player_model.conversion[SpellSlot],
            self.character_view.char_layout.ATTACK_LAYOUT: self.player_model.conversion[Attack],
            self.character_view.char_layout.SKILL_LAYOUT: self.player_model.conversion[Skill],
            self.character_view.char_layout.WEAPONS_LAYOUT: self.player_model.conversion[WeaponProf],
            self.character_view.char_layout.ARMOR_LAYOUT: self.player_model.conversion[ArmorProf],
            self.character_view.char_layout.LANGUAGES_LAYOUT: self.player_model.conversion[LanguageProf],
            self.character_view.char_layout.TOOLS_LAYOUT: self.player_model.conversion[ToolProf],
        }
