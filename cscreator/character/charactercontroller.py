...
from cscreator.character.charactermodel import CharacterModel
from cscreator.character.charactersubmodel import (
    CustomTableModel,
    CustomTableItemType,
    Equipment,
    Spell,
...
from cscreator.views.charactersubview import get_view_for_submodel
from cscreator.views.characterview import CharacterView
