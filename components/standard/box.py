...
from controllers.componentcontroller import (
    ComponentController,
    EditableProperty,
    PropertyTypes,
)
...
from components.utils import unit_str_to_float
import svgutils.transform as sg

from svg.text import text_width
    ...
    def create(self, box_width_pixels, box_height_pixels):
        ...
        text.add(
            text.text(
                ...
                fill="rgb(0,0,0)",
                style="font-size:2.5px; font-family:Arial".format(font_size),
            )
        )
